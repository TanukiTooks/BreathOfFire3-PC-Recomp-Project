...
R=Path(__file__).resolve().parents[1];O=R/'coverage/action-checks-native';O.mkdir(parents=True,exist_ok=True)
runpy.run_path(str(R/'scripts/prepare_substate_timers_native.py'),run_name='__main__')
inputs=json.loads((R/'startup-substate-timers-inputs.json').read_text());manifest=[]
...
targets=[(0x801c3790,0x801c37dc,'bof3_check_position_action_89'),(0x801c37dc,0x801c3828,'bof3_check_position_action_8a'),(0x801c364c,0x801c3790,'bof3_try_position_action_transition'),(0x801b544c,0x801b55c0,'bof3_try_primary_idle_transition')]
for lo,hi,name in targets:
 ...
 expected_prefix={0x801c3790:(0x27bdffe8,0x3c028014,0x94426258),0x801c37dc:(0x27bdffe8,0x3c028014,0x94426258),0x801c364c:(0x3c021f80,0x8c420044,0x27bdffd8),0x801b544c:(0x3c048014,0x8c846250,0x27bdffe8)}
